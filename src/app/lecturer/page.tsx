        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in">
          <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] flex flex-col overflow-hidden border border-slate-200">
            ...
            <div className="p-5 border-b border-slate-200 flex items-center justify-between bg-slate-50/80 shrink-0">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">Configure course, lecture date & time, and security</p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleCreateSession} className="flex-1 flex flex-col overflow-hidden">
              <div className="p-5 overflow-y-auto styled-scrollbar flex-1 space-y-4">
                {modalError && (
                ...
                <div className="space-y-1">
                  ...
                  {courses.length === 0 ? (
                    ...
                    <select
                      ...
                      required
                      className="w-full text-xs font-bold bg-slate-50 border border-slate-300 rounded-xl p-2.5 text-slate-900 focus:outline-none focus:ring-2 focus:ring-fuoye-green"
                    >
                      {courses.map((c) => (
                ...
                <div className="space-y-1.5 p-3 rounded-xl bg-purple-50/80 border border-purple-200">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-[11px] font-bold text-purple-700 hover:text-purple-950 bg-white px-2 py-0.5 rounded-lg border border-purple-300 shadow-2xs transition-colors cursor-pointer"
                    >
                ...
                <div className="space-y-2.5 pt-2 border-t border-slate-100">
                  ...
                  <label className="flex items-start gap-2.5 cursor-pointer p-2.5 rounded-xl border border-slate-200 hover:bg-slate-50 transition-colors">
                    <input
                      type="checkbox"
                      checked={requireQr}
              ...
              <div className="p-4 border-t border-slate-200 bg-slate-50/90 flex justify-end gap-2 shrink-0">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-fuoye-green text-white text-xs font-extrabold rounded-xl hover:bg-fuoye-green-dark flex items-center gap-1.5 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all cursor-pointer"
                >
                  {creating ? (
